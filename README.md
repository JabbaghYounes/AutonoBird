...
- **Dissertation V10 (2026-05-19)**: 8 embedded figures, all FR/NFR table rows updated with hardware-validated evidence where applicable, verdict upgraded from "supported in SITL" to **"supported in SITL plus hardware-validated software stack"**. Submission-ready
- **Remaining**: Stage 4 hardware flight — outdoor compass cal on grass + CG re-check at 945 g + tethered low-throttle thrust-margin test + first indoor netted hover
